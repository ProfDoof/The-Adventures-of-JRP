...
Dungeon::Dungeon() : northSouthIndex(3), eastWestIndex(0)
{
	...
	Map[0][2] = new Room(4,"Common Bedroom","You are in a common bedroom. It is fairly unremarkable, a small bed sits in the corner. A dresser and a wardrobe are on the opposite side of the room. There is a door leading South back to the hallway."); //Add Curio here
