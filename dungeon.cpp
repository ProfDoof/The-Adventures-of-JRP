...
Dungeon::Dungeon() : northSouthIndex(3), eastWestIndex(0)
{
	...
	Map[1][5] = new Room(0,"Hallway","You are in a strange hallway in the lower dungeon. There are stairs at the Easter end of it! How curious. There is a door to the West.");
